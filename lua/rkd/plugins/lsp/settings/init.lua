...
-- language servers
M.ts = require("rkd.plugins.lsp.settings.ts")
M.go = require("rkd.plugins.lsp.settings.go")
M.css = require("rkd.plugins.lsp.settings.css")
M.lua = require("rkd.plugins.lsp.settings.lua")
M.rust = require("rkd.plugins.lsp.settings.rust")
M.yaml = require("rkd.plugins.lsp.settings.yaml")
